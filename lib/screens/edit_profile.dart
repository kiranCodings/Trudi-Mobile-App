...
class _EditProfileState extends State<EditProfile> {
  ...
  String upfname = "", uplname = "", upmob = "", updetail = "", upaddress = "" ,upemail = "";
...
Future<bool> updateDetails(String email) async {
  ...
  if (_image == null) {
    ...
    _body = FormData.fromMap({
      ...
      "address": upaddress.toString(),
      "detail": updetail.toString(),
      "user_img": await MultipartFile.fromFile(_image!.path, filename: imagefileName)
    });
  }
  Response res;
  try {
          ...
          children: [
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                ...
                if (upemail == "") upemail = user.profileInstance.email!;
                if (upaddress == "")
